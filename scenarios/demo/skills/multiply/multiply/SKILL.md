...
- `python3 scenarios/demo/skills/multiply/scripts/multiply_numbers.py --a <a> --b <b>` — 纯计算，返回 JSON `{ok, result, message}`
...
1. 运行脚本得到计算结果：
   ```bash
   python3 scenarios/demo/skills/multiply/scripts/multiply_numbers.py --a <a> --b <b>
   ```
