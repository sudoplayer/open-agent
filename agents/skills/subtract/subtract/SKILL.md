...
- `python3 agents/skills/subtract/scripts/subtract_numbers.py --a <a> --b <b>` — 纯计算，返回 JSON `{ok, result, message}`
...
1. 运行脚本得到计算结果：
   ```bash
   python3 agents/skills/subtract/scripts/subtract_numbers.py --a <a> --b <b>
   ```
